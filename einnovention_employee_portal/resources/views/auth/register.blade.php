                        ...
                        <div class="login-form">
                            <form action="{{ route('register') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" placeholder="Username" id="name" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" placeholder="Email" id="email" type="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <input placeholder="Password" id="password" type="password"
                                        class="form-control @error('password') is-invalid @enderror au-input au-input--full"
                                ...
                                <div class="form-group">
                                    ...
                                    <input placeholder="Confirm Password" class="au-input au-input--full"
